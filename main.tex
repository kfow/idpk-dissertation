...
% The query which performs the best off (in terms of MAP score) is the \textit{All Terms Query} formed from \code{08DUSSELDORF36}, which discusses radical right wing extremism.
